...
**Actions**
- `freeze_top_process` — SIGSTOP top CPU offenders (configurable count, whitelist for `sshd`, `panicmode`, etc.)
...
**Infrastructure**
- Five supervised async tasks: Monitoring, Detector, Alert, Self-Check, HTTP API (+ ctl auxiliary)
